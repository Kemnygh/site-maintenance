...
-- CREATE TABLE sites (id serial PRIMARY KEY, name VARCHAR UNIQUE, description varchar, engineer_id INTEGER, location VARCHAR, location_id VARCHAR, created TIMESTAMP, updated TIMESTAMP, deleted VARCHAR DEFAULT 'FALSE');
-- CREATE DATABASE site_maintenance_test WITH TEMPLATE site_maintenance;
select * from engineers;
-- DROP DATABASE site_maintenance_test;
